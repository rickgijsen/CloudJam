...
export default class extends Phaser.Group {
    ...
    squish() {
        ...
        this.moveOutTween = this.game.add.tween(this.sprite)
            .to({x: this.game.world.centerX + 200, y: this.game.world.centerY+2000}, 3000, Phaser.Easing.Elastic.Out, true, 1500)
    ...
    rePosition() {
       ...
       // game.soundManager.playSound(this.getRandomFart(Math.floor(Math.random() * 5)))
        this.moveInTween = this.game.add.tween(this.sprite)
            ...
            .to({x: this.game.world.centerX+75, y: this.game.world.centerY +30}, 2000, Phaser.Easing.Elastic.Out, false)
